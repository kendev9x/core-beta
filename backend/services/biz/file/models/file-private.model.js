...
const fields = {
	...
	fileName: {
		type: String,
		require: [true, "fileName required"]
	},
	filePath: {
		type: String,
		require: [true, "filePath required"]
	},
	isPublic: {
		type: Boolean,
		default: false
...
class FilePrivateModel {
	...
	constructor(dbConnection, plugins = [], logger = {}) {
		...
		this.model = this.dbConnection.model(APP_SETTING.DB_COLLECTION.FILE, this.schema);
	}
...
module.exports = FilePrivateModel;

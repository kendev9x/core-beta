...
const fields = {
	id: { type: String },
	_id: { type: String },
	prefix: { type: String }, // system will use there for reset password
	name: { type: String },
	timing:  { type: Number, default: 60},
...
class ApiKeyModel {
	...
	constructor(dbConnection, plugins = [], logger = {}) {
		...
		this.model = this.dbConnection.model(APP_SETTING.DB_COLLECTION.API_KEY, this.schema);
	}

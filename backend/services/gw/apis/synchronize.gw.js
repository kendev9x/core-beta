...
class SynchronizeGw extends BaseGw {
	constructor(broker) {
		super(broker, {name: process.env.GATEWAY_SYNCHRONIZE_NAME});
		const _config = super.getConfig(process.env.GATEWAY_SYNCHRONIZE_CONFIG_NAME);
		this.parseServiceSchema({
			name: process.env.GATEWAY_SYNCHRONIZE_NAME,

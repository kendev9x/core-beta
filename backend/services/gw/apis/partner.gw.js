...
class PartnerGW extends BaseGw {
	constructor(broker) {
		super(broker, {name: process.env.GATEWAY_PARTNER_NAME});
		const _config = super.getConfig(process.env.GATEWAY_PARTNER_CONFIG_NAME);
		this.parseServiceSchema({
			name: process.env.GATEWAY_PARNER_NAME,

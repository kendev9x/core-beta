...
class AccountPortalRoutes extends BaseRoute {
	...
	/** Register all url endpoint published for account service use at Web Portal */
	registerAlias() {
		return {
			"GET /customer/":
	...
	/** Register route setting for account service use at Web Portal */
	registerRoute() {
		const sef = this;
		return {
...
module.exports = AccountPortalRoutes;